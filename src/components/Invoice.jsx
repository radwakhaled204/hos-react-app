...
useEffect(() => {
  const fetchFromStores = async () => {
    try {
      if (fromMainStores.length === 0) {
        const res1 = await axios.get("https://www.istmob.somee.com/api/Stoc/stoc1");
        setFromMainStores(res1.data);
      }
      if (fromSelectedMainStore) {
        const res = await axios.get(`https://www.istmob.somee.com/api/Stoc/stoc2?name1=${encodeURIComponent(fromSelectedMainStore)}`);
  ...
  fetchFromStores();
}, [fromSelectedMainStore, fromMainStores.length]);
    ...
    useEffect(() => {
      const fetchToStores = async () => {
        try {
          ...
          if (toSelectedMainStore) {
            const res = await axios.get(`https://www.istmob.somee.com/api/Stoc/stoc2?name1=${encodeURIComponent(toSelectedMainStore)}`);
      ...
      fetchToStores();
    }, [toSelectedMainStore, toMainStores.length]);
    ...
    useEffect(() => {
      const fetchInitialData = async () => {
        try {
          ...
          const res = await axios.get(`https://www.istmob.somee.com/api/Stoc/stoc_items_trans?${queryString}`);
    ...
    useEffect(() => {
      const fetchClients = async () => {
        try {
          const res = await axios.get("https://www.istmob.somee.com/api/client/client");
    ...
    const handleNameChange = async (e) => {
      ...
      try {
        const res = await axios.get("https://www.istmob.somee.com/api/items/items");
    ...
    const fetchItemData = async (code) => {
      ...
      try {
        const res = await axios.get(`https://www.istmob.somee.com/api/items/ItemPrice?code=${code}`);
    ...
    const handleAddItems = async () => {
      try {
        for (const row of rows) {
          ...
          await axios.post("https://www.istmob.somee.com/api/Stoc/insert_stoc_items_trans", payload);
                          ...
                          {[
                            {
                              ...
                              action: async () => {
                                ...
                                try {
                                  await axios.delete(`https://www.istmob.somee.com/api/Stoc/delete-item/${id}`);
